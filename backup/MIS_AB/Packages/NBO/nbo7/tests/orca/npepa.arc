...
| 11> 
| 12> %nbo
| 13> nbokeylist = "$nbo nrt archive $end"
...
---------------
  ...
  Last Orbital Rotation      ...    5.2441e-05  Tolerance :   5.0000e-05
             ...
             **** THE GBW FILE WAS UPDATED (npepa.gbw) ****
             **** DENSITY FILE WAS UPDATED (npepa.scfp.tmp) ****
             **** ENERGY FILE WAS UPDATED (npepa.en.tmp) ****
----------------
ORBITAL ENERGIES
----------------
 ...
 ***************************** development version *****************************
  (c) Copyright 1996-2018 Board of Regents of the University of Wisconsin System
      on behalf of the Theoretical Chemistry Institute.  All rights reserved.
          ...
          Cite this program [NBO 7.0.0 (15-Aug-2018)] as:
       ...
       /NPEPA  / : Perform Natural Poly-Electron Population Analysis

 Filename set to npepa

 Job title:  ORCA Job: npepa
 ...
 * Total *  0.00000      3.99961    13.98783    0.01255    18.00000
 ...
 ===============================================================================
    0.952523    <R 1a-9a 1b-9b>
    0.014581    <X1 3a/11a> + <X1 3b/11b>        3.  N 2(lp)     11.  C 1- H 3*
    0.003920    <X1 9a/13a> + <X1 9b/13b>        9.  N 2- H 7    13.  C 1- H 5*
    0.003920    <X1 8a/12a> + <X1 8b/12b>        8.  N 2- H 6    12.  C 1- H 4*
    0.003894    <X1 7a/15a> + <X1 7b/15b>        7.  C 1- H 5    15.  N 2- H 7*
    0.003894    <X1 6a/14a> + <X1 6b/14b>        6.  C 1- H 4    14.  N 2- H 6*
    0.002611    <X1 3a/13a> + <X1 3b/13b>        3.  N 2(lp)     13.  C 1- H 5*
    0.002611    <X1 3a/12a> + <X1 3b/12b>        3.  N 2(lp)     12.  C 1- H 4*
 -------------------------------------------------------------------------------

      Born
  Probability   User-selected Configuration(s) (NBO basis functions)
 ===============================================================================
    0.000000    </3a 11a 3b 11b>
    0.000002    <3a/11a 3b 11b>
    0.000266    <11a/3a 3b 11b>
    0.000001    <3a 11a/3b 11b>
    0.000002    <3b/3a 11a 11b>
    0.000057    <3a 3b/11a 11b>
    0.007480    <11a 3b/3a 11b>
    0.000026    <3a 11a 3b/11b>
    0.000266    <11b/3a 11a 3b>
    0.007480    <3a 11b/11a 3b>
    0.977554    <11a 11b/3a 3b>
    0.003413    <3a 11a 11b/3b>
    0.000001    <3b 11b/3a 11a>
    0.000026    <3a 3b 11b/11a>
    0.003413    <11a 3b 11b/3a>
    0.000012    <3a 11a 3b 11b/>
    1.000000    <S 3a 11a 3b 11b>

 NBO analysis completed in 0.06 CPU seconds (0 wall seconds)
 Maximum scratch memory used by NBO was 313878 words (2.39 MB)
...
Sum of individual times     ....       2.745 sec  (113.5%)

Fock matrix formation       ....       1.818 sec  ( 75.2%)
Diagonalization             ....       0.002 sec  (  0.1%)
Density matrix formation    ....       0.000 sec  (  0.0%)
Population analysis         ....       0.689 sec  ( 28.5%)
Initial guess               ....       0.161 sec  (  6.7%)
Orbital Transformation      ....       0.000 sec  (  0.0%)
Orbital Orthonormalization  ....       0.000 sec  (  0.0%)
DIIS solution               ....       0.001 sec  (  0.0%)
SOSCF solution              ....       0.025 sec  (  1.0%)
...
GBWName                                         ... npepa.gbw
Electron density file                           ... npepa.scfp.tmp
...
Sum of individual times         ...        2.725 sec (=   0.045 min)
GTO integral calculation        ...        0.296 sec (=   0.005 min)  10.9 %
SCF iterations                  ...        2.429 sec (=   0.040 min)  89.1 %
                             ****ORCA TERMINATED NORMALLY****
TOTAL RUN TIME: 0 days 0 hours 0 minutes 2 seconds 860 msec
The following scratch files deleted on neutron
total 160
-rw-rw-r-- 1 ericg ericg 60819 Nov 12 22:35 npepa.47
-rw-rw-r-- 1 ericg ericg  3248 Nov 12 22:35 npepa.f0.tmp
-rw-rw-r-- 1 ericg ericg 85753 Nov 12 22:35 npepa.gbw
-rw-rw-r-- 1 ericg ericg   418 Nov 12 22:35 npepa.inp
-rw-rw-r-- 1 ericg ericg     4 Nov 12 22:35 npepa.prop
-rw-rw-r-- 1 ericg ericg  1299 Nov 12 22:35 npepa_property.txt
